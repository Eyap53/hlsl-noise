//
// Description : Array and textureless HLSL 2D classic noise function.
...
void ClassicNoise2D_float(float2 input, out float output)
{
    output = cnoise(input);
}

void ClassicNoise2DPeriodic_float(float2 input, float2 rep, out float output)
{
    output = pnoise(input, rep);
}
